...
inpt = input('Please enter file name: ')    #runtime O(1)
if is_file_sorted(inpt) == False:   #runtime O(N)
    print('Looks like ' + inpt + ' needs to be sorted')     #Runtime O(1)
else:   #Runtime o(1)
    print('Congratulations! The file ' + inpt +' is nicely sorted!')    #Runtime O(1)
#TOTAL RUNTIME: O(n), because the largest runtime within the code is o(n).
